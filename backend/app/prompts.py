"""All LLM prompt templates used by app.ontology, kept in one module so the
prompt text (and the design-rationale comments attached to each one) can be
read/edited independently of the extraction/storage logic that fills them in
